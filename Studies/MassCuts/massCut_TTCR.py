...
if __name__ == "__main__":
    ...
    df_initial_DY = ROOT.RDataFrame(
        "Events",
        f"/eos/user/v/vdamante/HH_bbtautau_resonant_Run2/anaTuples/v10_deepTau2p1_HTT/Run2_{args.year}/DYJetsToLL_M-50-amcatnloFXFX/*.root",
    )
    ...
    dfWrapped_DY = PrepareDfForHistograms(
        DataFrameBuilderForHistograms(
            df_initial_DY, global_cfg_dict, f"Run2_{args.year}"
        )
    )
    GetIntervals.GetMassCut(
        dfWrapped_DY,
        global_cfg_dict,
    ...
    inFiles = Utilities.ListToVector(
        [
            ...
            f"/eos/user/v/vdamante/HH_bbtautau_resonant_Run2/anaTuples/v10_deepTau2p1_HTT/Run2_{args.year}/GluGluToBulkGravitonToHHTo2B2Tau_M-900/nanoHTT_0.root",
            f"/eos/user/v/vdamante/HH_bbtautau_resonant_Run2/anaTuples/v10_deepTau2p1_HTT/Run2_{args.year}/GluGluToRadionToHHTo2B2Tau_M-1000/nanoHTT_0.root",
