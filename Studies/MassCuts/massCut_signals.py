...
if __name__ == "__main__":
    ...
    particleNet_mass = (
        "particleNet_mass"
        if "SelectedFatJet_particleNet_mass_boosted" in dfWrapped.df.GetColumnNames()
    ...
    if args.cat == "res2b":
        GetIntervalsSimultaneously.GetMassCut(
            dfWrapped,
            global_cfg_dict,
            ["eTau", "muTau", "tauTau"],
            ["res2b"],
    ...
    if args.cat == "res1b":
        GetIntervalsSimultaneously.GetMassCut(
            dfWrapped, global_cfg_dict, ["eTau", "muTau", "tauTau"], ["res1b"], 0.99
        )  # ["res1b_cat3", "res1b_cat2"]
    ...
    if args.cat == "boosted":
        GetIntervalsSimultaneously.GetMassCut(
            dfWrapped, global_cfg_dict, ["eTau", "muTau", "tauTau"], ["boosted"], 0.99
        )
