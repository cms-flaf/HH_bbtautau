...
def PrepareDfForHistograms(dfForHistograms):
    for leg_idx in [1, 2]:
        ...
        dfForHistograms.df = dfForHistograms.df.Redefine(tau_legType, f'static_cast<Leg>({tau_legType})')
        dfForHistograms.df = dfForHistograms.df.Define(f'b{leg_idx}_legType', f'b{leg_idx}_pt > 0 ? Leg::jet : Leg::none')
